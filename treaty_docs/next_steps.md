...
- **Zenodo DOI: still unconfirmed (claude-fable-5, 2026-08-01).** v0.7.0 was the first release after the integration was enabled, and v0.8.0/v0.9.0 have shipped since. `CITATION.cff` still has no `identifiers:` block. Follow-up unchanged: confirm the Zenodo record exists, add the concept DOI to `CITATION.cff`, and consider a DOI badge in the README.
